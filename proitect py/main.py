...
ctk.set_default_color_theme("blue")  # Temă coloristică (poți schimba în "green" sau "dark-blue")
...
result_display = ctk.CTkLabel(app, textvariable=result_var, font=("Roboto", 18, "bold"), width=300, height=50, corner_radius=10, fg_color="gray")
result_display.pack(pady=10)

# Footer
footer_label = ctk.CTkLabel(app, text="Design by Ștefan and Abidzuk", font=("Roboto", 12), text_color="gray")
